                ...
                .on("mousemove", (evt, d) => {
                    ...
                    tooltip
                        ...
                        .html(`
                            ...
                            <p>${translate('LAC', inEn)}: ${formatNumber(lineData.find(ld => ld.Country === 'Latin America and the Caribbean').Value, inEn)}</p>
                            <p>${translate('World', inEn)}: ${formatNumber(lineData.find(ld => ld.Country === 'World').Value, inEn)}</p>
                        `);
